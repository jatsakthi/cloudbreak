...
public class AwsLaunchService {
    ...
    public List<CloudResourceStatus> launch(AuthenticatedContext ac, CloudStack stack, PersistenceNotifier resourceNotifier,
        ...
        try {
            ...
            ModelContext modelContext = new ModelContext()
                    ...
                    .withPrefixListIds(getPrefixListIds(amazonEC2Client, enabledGatewayServices.stream()
    ...
    private List<String> getPrefixListIds(AmazonEC2Client amazonEC2Client, Set<String> serviceNames) {
        List<String> result = List.of();
        if (CollectionUtils.isNotEmpty(serviceNames)) {
            result = amazonEC2Client.describePrefixLists().getPrefixLists().stream()
                    .filter(pl -> serviceNames.contains(pl.getPrefixListName()))
