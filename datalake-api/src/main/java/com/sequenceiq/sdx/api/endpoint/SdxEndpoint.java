...
public interface SdxEndpoint {
    ...
    SdxDatabaseBackupResponse backupDatabase(@PathParam("name") String name, String backupLocation);
    ...
    SdxDatabaseRestoreResponse restoreDatabase(@PathParam("name") String name, String backupLocation);
    ...
    public SdxDatabaseBackupStatusResponse backupDatabaseStatus(@PathParam("name") String name, String operationId);
    ...
    public SdxDatabaseRestoreStatusResponse restoreDatabaseStatus(@PathParam("name") String name, String operationId);
}
